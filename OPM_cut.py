...
def remove_outside_residues(input_file, size_fasta, min_size, max_size, output_format, output_file=None, margin=3.0, max_gap=5, keepmb=False, verbose=False):
    ...
    # First pass: determine the z-values of residues and of the two membrane layers
    ...
    if verbose : print(f'inner_membrane_z: {inner_membrane_z}, outer_membrane_z: {outer_membrane_z}, min_membrane_x: {min_membrane_x}, max_membrane_x: {max_membrane_x}, min_membrane_y: {min_membrane_y}, max_membrane_y: {max_membrane_y}')
